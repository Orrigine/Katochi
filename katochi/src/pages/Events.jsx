                        ...
                        <>
                            {nextEvents.map((data) =>
                                ...
                                <Col key={data.id} sm="12" lg="8">
                                    ...
                                    <Row>
                                        <Col>
                                            <img className="image" src={"http://localhost:1337" + data.attributes.image1.data.attributes.url} alt="" />
                                        </Col>
                                        <Col className="col-text">
                                            ...
                                            <Row className=''>
                                                <Col lg={{ span: 10, offset: 1 }} md={{ span: 10, offset: 1 }} sm={{ span: 10, offset: 1 }} xs={{ span: 10, offset: 1 }}>
                                                    <img className="ligne" src={ligne} alt="" />
                                                </Col>
                                            </Row>
                                    ...
                                    <Row className="__margin">
                                        ...
                                        <Col>
                                            <img className="image" src={"http://localhost:1337" + data.attributes.image2.data.attributes.url} alt="" />
                                        </Col>
                                    </Row>
                                    <Row className="__margin">
                                        <Col>
                                            <img className="image" src={"http://localhost:1337" + data.attributes.image3.data.attributes.url} alt="" />
                                        </Col>
                                        <Col className="col-text">
                                            <Row className=''>
